...
export function GoogleSignInButton({
  ...
  async function handleGoogleSignIn() {
    ...
    const destination = resolveAuthRedirect({
      ...
      plan,
      ref,
      fallback: mode === "sign-up" ? "/pricing" : "/app",
    });
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)}>
      <Button
        type="button"
        variant="outline"
        className="min-h-11 w-full gap-2.5 border-[var(--marketing-border)] bg-card font-medium"
        disabled={pending}
...
export function AuthDivider() {
  ...
  return (
    <div className="relative py-1">
      ...
      <p className="relative flex justify-center text-xs uppercase tracking-wide">
